<!-- ./gpt-sovits-frontend/src/views/Home.vue -->
<template>
  <div class="home-container">
    ...
    <section class="voice-preview-section">
      ...
      <div class="voice-card-list">
        <div v-for="(voice, index) in topVoices" :key="voice.id" class="voice-card" @click="goToTTS(voice)">
...
const banners = ref([
  {
    image: createImageUrl('banner1'),
    title: '高拟真语音生成体验',
    description: '依托 So-VITS 与 GPT 技术，支持多情感 TTS 与角色音色自定义'
  },
  {
    image: createImageUrl('banner2'),
    title: '小样本音色克隆',
...
const topVoices = ref([
  {
    id: 1,
    name: '诗仙李白',
    avatar: createImageUrl('voice1')
  },
  {
    id: 2,
    name: '文雅',
    avatar: createImageUrl('voice2')
  },
  {
    id: 3,
    name: '贞烨',
    avatar: createImageUrl('voice3')
  },
  {
    id: 4,
    name: '恬雅',
    avatar: createImageUrl('voice4')
  },
  {
    id: 5,
    name: '海化',
    avatar: createImageUrl('voice5')
  }
])
