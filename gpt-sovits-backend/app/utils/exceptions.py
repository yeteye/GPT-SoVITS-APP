...
class AudioProcessingError(Exception):
    ...
    def __init__(self, message="Audio processing failed", status_code=422):
...
class TaskProcessingError(Exception):
    ...
    def __init__(self, message="Task processing failed", status_code=500):
        super().__init__(message)
        self.status_code = status_code
...
class ServiceUnavailableError(Exception):
    ...
    def __init__(self, message="Service temporarily unavailable", status_code=503):
        super().__init__(message)
        self.status_code = status_code
